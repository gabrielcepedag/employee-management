...
public class EmployeeManagerTest {
    ...
    public void testCalculateTotalSalary() {
        ...
        assertEquals(employeeManager.calculateTotalSalary(), total);
    }
    ...
    public void testUpdateEmployeeSalaryValid() {
        ...
        assertEquals(45000, employeeManager.getEmployees().get(0).getSalary());
    }
    ...
    public void testUpdateEmployeeSalaryInvalid() {
        ...
        assertThrows(InvalidSalaryException.class, () -> employeeManager.updateEmployeeSalary(employee1,70000));
    }
    ...
    public void testUpdateEmployeePositionValid() {
        ...
        assertEquals(seniorDeveloper, employeeManager.getEmployees().get(1).getPosition());
    }
    ...
    public void testAddEmployeeWithInvalidSalary() {
        ...
        Employee employee = new Employee("3", "La parita", juniorDeveloper, 60000);
        // - Verificar que se lanza una InvalidSalaryException al agregar este empleado.
        assertThrows(InvalidSalaryException.class, () -> employeeManager.addEmployee(employee));
        // - Crear otro empleado con un salario de 40000 para seniorDeveloper.
        Employee employee_test = new Employee("4", "Freddy Meda Pena", seniorDeveloper, 40000);
        // - Verificar que se lanza una InvalidSalaryException al agregar este empleado.
        assertThrows(InvalidSalaryException.class, () -> employeeManager.addEmployee(employee_test));
    }
